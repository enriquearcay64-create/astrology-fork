...
def policy_manifest() -> Dict[str, object]:
    ...
    return {
        ...
        "semantic_registry_version": "3.0.0-boundaries",
        "timing_version": "3.0.0",
        "report_template_version": "3.0.0-reasoned-synthesis",
        "zodiac": "tropical",
        ...
        "house_policy": {
            ...
            "integration_states": ["convergence_strong", "whole_topic_placidus_qualifier", "complementary_emphases", "material_divergence", "placidus_unavailable"],
        ...
        "report_design_policy": "portable Markdown; executive/deep/technical separation; five core themes in human-first prose; one lived example for each of the three leading themes; Whole Sign and Placidus differences named only when material; timing translated before technical labels; distinct introduction and synthesis; no decorative animation",
