...
def humanization_instructions(language: str = "pt-BR") -> str:
    ...
    if language.startswith("pt"):
        return (
            ...
            "Arquitetura e respiração de cada capítulo de domínio: cada domínio deve ser desenvolvido com densidade, nuance e acolhimento, desdobrando-se organicamente em parágrafos com profundidade adaptada ao valor distinto de cada mecanismo (evite rigorosamente parágrafos únicos comprimidos ou monólitos maciços de texto): "
    ...
    return (
        ...
        "Chapter architecture and breathing room: each domain chapter must be developed with depth, nuance, and warmth across paragraphs of adaptive depth (strictly avoid single-paragraph compressed monoliths of text): "
        ...
        "Whole-Chart Opening Architecture: the opening section ('## Arquitetura do mapa') must contain connected paragraphs of adaptive depth of relational synthesis between the chart's structural axes. It is strictly forbidden to present an isolated inventory of placements (e.g. dedicating a separate paragraph or bullet to each planet or mandatory factor). Mandatory factors must be woven together within the relational dynamics organizing the chart. "
        ...
        "Final integration organizes the whole person through a concrete higher-order synthesis of the map, avoiding abstract clichés ('highest synthesis', 'inhabiting one's center', 'conscious integrity', 'inner sovereignty') when direct formulations communicate better, and offers reflection where it helps test integration in real life. "
