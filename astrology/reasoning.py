...
def humanization_verifier_instructions(language: str = "pt-BR") -> str:
    ...
    if language.startswith("pt"):
        return (
            ...
            "acrescente consequência própria do domínio, que a integração final desenvolva síntese memorável em vez de resumo, e preserve exatamente qualquer aviso determinístico indisponível."
        )
    return (
