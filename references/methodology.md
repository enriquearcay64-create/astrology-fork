...
6. `ChartSignature` define se há uma dinâmica central suportada ou centros distribuídos; `NarrativePlanner` escolhe ordem, referências cruzadas e detalhes técnicos a ocultar. Ele usa corpos e ids tipados, nunca fragmentos de texto de aspectos.
